  ...
  >
    ...
    <div class="flex-1 min-w-0">
      ...
      <div class="flex items-center gap-1.5 mt-0.5">
        <span class="text-[11px] px-1 py-0.5 rounded bg-n-alpha-1 text-n-slate-10 flex-shrink-0">
          {{ chatTypeLabel }}
        </span>
        <span
          v-if="chat.lastMessageText"
          class="text-xs truncate"
          :class="unreadCount > 0 ? 'text-n-slate-12 font-medium' : 'text-n-slate-10'"
        >
