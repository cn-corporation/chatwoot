export default {
  ...
  UPDATE_CONVERSATIONS_FOR_COUNTS: 'UPDATE_CONVERSATIONS_FOR_COUNTS',
  ...
  SET_REQUEST_COUNTER: 'SET_REQUEST_COUNTER',
  ...
  SET_AUTOMATION_SOURCE_MAPPINGS: 'SET_AUTOMATION_SOURCE_MAPPINGS',
  UPDATE_AUTOMATION_SOURCES: 'UPDATE_AUTOMATION_SOURCES',
  SET_AUTOMATION_EXTRA_UUIDS: 'SET_AUTOMATION_EXTRA_UUIDS',
  UPDATE_AUTOMATION_EXTRA_UUID: 'UPDATE_AUTOMATION_EXTRA_UUID',
  ...
  SET_BULK_MESSAGE_MODE: 'SET_BULK_MESSAGE_MODE',
  ...
  SET_MACRO_SOURCE_MAPPINGS: 'SET_MACRO_SOURCE_MAPPINGS',
  UPDATE_MACRO_SOURCES: 'UPDATE_MACRO_SOURCES',
  SET_MACRO_EXTRA_UUIDS: 'SET_MACRO_EXTRA_UUIDS',
  UPDATE_MACRO_EXTRA_UUID: 'UPDATE_MACRO_EXTRA_UUID',
  ...
  // Ads
  SET_ADS_UI_FLAG: 'SET_ADS_UI_FLAG',
  SET_ADS: 'SET_ADS',
  ADD_AD: 'ADD_AD',
  EDIT_AD: 'EDIT_AD',
  DELETE_AD: 'DELETE_AD',
  SET_SEND_OPERATION: 'SET_SEND_OPERATION',
  SET_SEND_OPERATIONS_HISTORY: 'SET_SEND_OPERATIONS_HISTORY',
  SET_ERROR_LOGS: 'SET_ERROR_LOGS',
  SET_ACTIVE_SCHEDULES: 'SET_ACTIVE_SCHEDULES',
  SET_ACTIVE_SCHEDULE_FOR_AD: 'SET_ACTIVE_SCHEDULE_FOR_AD',
  REMOVE_ACTIVE_SCHEDULE_FOR_AD: 'REMOVE_ACTIVE_SCHEDULE_FOR_AD',
  SET_SCHEDULE_HISTORY: 'SET_SCHEDULE_HISTORY',

  // Conversation Export
  SET_CONVERSATION_EXPORT_UI_FLAG: 'SET_CONVERSATION_EXPORT_UI_FLAG',
  SET_CONVERSATION_EXPORTS: 'SET_CONVERSATION_EXPORTS',
  SET_CONVERSATION_EXPORT: 'SET_CONVERSATION_EXPORT',
  SET_CONVERSATION_EXPORT_ANALYSES: 'SET_CONVERSATION_EXPORT_ANALYSES',
  SET_CONVERSATION_EXPORT_ANALYSIS: 'SET_CONVERSATION_EXPORT_ANALYSIS',
  CLEAR_CONVERSATION_EXPORT_ANALYSES: 'CLEAR_CONVERSATION_EXPORT_ANALYSES',

  // Operator Notifications
  SET_OPERATOR_NOTIFICATION_COUNT: 'SET_OPERATOR_NOTIFICATION_COUNT',
  SET_OPERATOR_NOTIFICATIONS_READY: 'SET_OPERATOR_NOTIFICATIONS_READY',
  CLEAR_OPERATOR_NOTIFICATIONS: 'CLEAR_OPERATOR_NOTIFICATIONS',

  // Conversation Topics
  SET_CONVERSATION_TOPIC: 'SET_CONVERSATION_TOPIC',
  CLEAR_CONVERSATION_TOPICS: 'CLEAR_CONVERSATION_TOPICS',

  // Personal Canned Responses
  SET_PERSONAL_CANNED_UI_FLAG: 'SET_PERSONAL_CANNED_UI_FLAG',
  SET_PERSONAL_CANNED: 'SET_PERSONAL_CANNED',
  ADD_PERSONAL_CANNED: 'ADD_PERSONAL_CANNED',
  EDIT_PERSONAL_CANNED: 'EDIT_PERSONAL_CANNED',
  DELETE_PERSONAL_CANNED: 'DELETE_PERSONAL_CANNED',
  SET_ALL_PERSONAL_CANNED: 'SET_ALL_PERSONAL_CANNED',

  // Knowledge Base
  SET_KB_FILES_UI_FLAG: 'SET_KB_FILES_UI_FLAG',
  SET_KB_FILES: 'SET_KB_FILES',
  ADD_KB_FILE: 'ADD_KB_FILE',
  DELETE_KB_FILE: 'DELETE_KB_FILE',
  SET_KB_FILE_CONTENT: 'SET_KB_FILE_CONTENT',
};
